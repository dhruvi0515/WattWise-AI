...
# Use absolute standard path execution compatible with both local and Vercel structures
from config import (
...
# Global WSGI application instance variable exposed cleanly for the Vercel builder
app = create_app()